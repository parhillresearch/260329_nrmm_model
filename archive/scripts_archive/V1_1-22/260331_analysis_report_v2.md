...
**Date:** 31 March 2026 \| **Data period:** 2016–2024 \| **Research Plan:** v1.17 **n = 10,749 audit records across three equipment groups**
...
**Full warm fleet (all records):** ![Warm fleet compliance — all records](260331_compliance_warm.png)

**Compliant-warm subset (λ_Policy estimation basis):** ![Warm fleet compliance — compliant subset only](260331_compliance_warm_pol.png)

...
_Version 1 | 17 April 2026_  
_Script: `outputs/260417_step6_methods_findings_v1.md` (Step 6, no R script)_  
...
| ē Phase B (% below threshold) | 82.8% (Stage V imposed on IIIA fleet) | CAZ+: 19.9%; RoL: 5.2% |
...
**Findings:** BCP exclusions removed a small number of records from the geographic scope. COVID exemptions removed a further subset within the Phase B window. Final retained record count after all exclusions: 15,932.
...
|---|---|---|---|---|
| Constant\_Speed | 22.1% | 22.1% | 82.8% | 30.4% |
| CAZ\_Plus | 20.2% | 11.2% | 19.9% | — |
| Rest\_of\_London | 3.5% | 5.2% | 4.7% | — |
...
| CAZ\_Plus | 0.275 | 0.262 | 0.013 | 2,000+ |
| Rest\_of\_London | 0.194 | 0.241 | 0.000 (floored) | large |
...
| CAZ\_Plus | 1.826 | 0.201 | 0.010 (≈ CAZ+ only) |
| Rest\_of\_London | 2.128 | 0.161 | 0.000 |
| Variable\_Speed | ~2.0 (wtd avg) | 0.168 | 0.002 (wtd avg) |
...
CS initialisation: substantial Stage IIIA tail (38.5%) alongside Stage V majority; IIIB and IV absent, consistent with CS estimation max\_stage = 3. VS: overwhelmingly Stage V (76.5%) with non-compliant tail across all lower stages.
...
_End of report. Generated 17 April 2026._

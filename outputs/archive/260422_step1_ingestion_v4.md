# Step 1 Outputs — 260422_step1_ingestion_v4

Generated: 2026-04-22 11:22:22
...
![Excluded records by year and reason](260422_step1_ingestion_v4_excl_by_year.png)
...
![Stage distribution by year](260422_step1_ingestion_v4_stage_by_year.png)
...
![Stage distribution by year and group](260422_step1_ingestion_v4_stage_by_year_group.png)
...
<table class="table table-condensed" style="width: auto !important; margin-left: auto; margin-right: auto;">
<caption>Compliance status by year — hierarchical non-compliance code assignment</caption>
 <thead>
  <tr>
   <th style="text-align:right;"> year </th>
   <th style="text-align:right;"> E: Emissions </th>
   <th style="text-align:right;"> Other (A/C/P/X) </th>
   <th style="text-align:right;"> R: Registration </th>
   <th style="text-align:right;"> Total </th>
  </tr>
 </thead>
<tbody>
...
Each machine is counted once only, assigned to its highest-priority non-compliance category (E > R > Other > Compliant).
Row totals should equal the total unique records for that year, confirming complete coverage.

![Non-compliant machines by top code category](260422_step1_ingestion_v4_noncompliance_codes_year.png)

Emissions non-compliance (E) is the dominant category throughout, confirming the fleet's primary compliance challenge is emissions standard rather than administrative issues.
Registration non-compliance (R) is a secondary but persistent category; Other codes (A/C/P/X) are minor.

![Compliant vs non-compliant machines by year](260422_step1_ingestion_v4_compliance_vs_noncompliance_year.png)

The compliant (green) segment grows over time as the fleet improves, while the emissions non-compliant (red) segment shrinks — the primary visual indicator of LEZ policy effectiveness.
Registration and Other non-compliance remain relatively small and stable throughout the series.


### 8d. Primary group and engagement type by year (unique records)

![Group and engagement type by year](260422_step1_ingestion_v4_group_engagement_year.png)
...
![Variable_Speed continuous by year](260422_step1_ingestion_v4_vs_continuous_year.png)

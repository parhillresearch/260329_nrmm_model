...
|---|---|---|
| `notes.md` (this file) | State of play, model derivation, parameter register, open decisions, decision log | Canonical for methods and decisions |
| `outputs/260728_data_dictionary.md` | Every field, every value, its disposition, and all 13 data-quality facts | Canonical for the data; generated by `260728_data_dictionary.R` |
| `plans/schema.md` | Definitions, thresholds, Machine Groups; sections 2a and 3aa record where the data departs from the design | Canonical for definitions |
...
Superseded documents carry a banner at the top. Superseded scripts likewise.
